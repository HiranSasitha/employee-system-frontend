...
const EmployeeManage = () => {
    ...
    const handleSubmit = async(event) => {
     ...
     const   data = {
        ...
        const response = await axios.post("https://localhost:7087/api/Employee/save",data);
                ...
                <div class="card-body">
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="mb-3">
                            ...
                            <select className="form-select mb-3" onChange={handleSelectDepartment} value={selectedDepartmentId} required>
